...
public class PounceTest {

   private Pounce systemUnderTest;

   @Before public void initialiseSystemUnderTest() {
      TestApplication.startPlatform();
      MockitoAnnotations.initMocks( this );
      systemUnderTest = new Pounce();
   }//End Method
   ...
   @Test public void shouldApplyDamage() {
      ...
      assertThat( raptor.health().get(), is( Velociraptor.health() - Stegosaurus.damage() * 2 ) );
      assertThat( stego.health().get(), is( Stegosaurus.health() ) );
   }//End Method
   ...
   @Test public void shouldAbsorbDamageInArmor() {
      ...
      assertThat( raptor.health().get(), is( Velociraptor.health() ) );
      assertThat( stego.health().get(), is( 2388 ) );
   }//End Method
